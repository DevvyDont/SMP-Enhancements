...
public class RNGRoller {
    ...
    public static final float LUCK_OF_THE_SEA_BOOST = 1f;  // For every level of luck how much should we boost the chance?
    ...
    private final Enchantment enchantToBoost;
    ...
    public float getLuckMultiplier() {
        return (float) (1 + (player.getAttribute(Attribute.LUCK).getValue() * LUCK_OF_THE_SEA_BOOST) + getEnchantLevels() * ENCHANTMENT_BOOST);
    }
