...
public class ProsperousSwordBlueprint extends CustomItemBlueprint {
    ...
    protected ItemStack constructBaseItemStack() {
        ...
        itemMeta.setDisplayName(ChatColor.LIGHT_PURPLE.toString() + ChatColor.BOLD + "Prosperous Sword");
    ...
    public Map<Enchantment, PotentialEnchantmentWrapper> getAllowedEnchants() {
        ...
        allowedEnchants.put(Enchantment.DAMAGE_ALL, new PotentialEnchantmentWrapper(Enchantment.DAMAGE_ALL, 3, 6, .9f));
        allowedEnchants.put(Enchantment.LOOT_BONUS_MOBS, new PotentialEnchantmentWrapper(Enchantment.LOOT_BONUS_MOBS, 4, 7, PotentialEnchantmentWrapper.GUARANTEED_CHANCE));
        allowedEnchants.put(Enchantment.DAMAGE_UNDEAD, new PotentialEnchantmentWrapper(Enchantment.DAMAGE_UNDEAD, 1, 3, .15f));
        allowedEnchants.put(Enchantment.DAMAGE_ARTHROPODS, new PotentialEnchantmentWrapper(Enchantment.DAMAGE_ARTHROPODS, 1, 3, .15f));
