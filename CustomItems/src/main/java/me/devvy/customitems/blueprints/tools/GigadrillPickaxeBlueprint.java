...
public class GigadrillPickaxeBlueprint extends CustomItemBlueprint {
    ...
    public Map<Enchantment, PotentialEnchantmentWrapper> getAllowedEnchants() {
        ...
        allowedEnchants.put(Enchantment.DIG_SPEED, new PotentialEnchantmentWrapper(Enchantment.DIG_SPEED, 6, 10, PotentialEnchantmentWrapper.GUARANTEED_CHANCE));
        allowedEnchants.put(Enchantment.SILK_TOUCH, new PotentialEnchantmentWrapper(Enchantment.SILK_TOUCH, 1, 1, .5f));
        allowedEnchants.put(Enchantment.DURABILITY, new PotentialEnchantmentWrapper(Enchantment.DURABILITY, 150, 250, PotentialEnchantmentWrapper.GUARANTEED_CHANCE));
