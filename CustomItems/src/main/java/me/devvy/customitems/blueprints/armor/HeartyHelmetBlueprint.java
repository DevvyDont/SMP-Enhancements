...
public class HeartyHelmetBlueprint extends CustomItemBlueprint {
    ...
    protected ItemStack constructBaseItemStack() {
        ...
        itemMeta.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, new AttributeModifier(UUID.randomUUID(), "max_hp", 4, org.bukkit.attribute.AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HEAD));
        itemMeta.addAttributeModifier(Attribute.GENERIC_ARMOR, new AttributeModifier(UUID.randomUUID(), "armor", 3, org.bukkit.attribute.AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HEAD));
        itemMeta.addAttributeModifier(Attribute.GENERIC_ARMOR_TOUGHNESS, new AttributeModifier(UUID.randomUUID(), "toughness", 2, org.bukkit.attribute.AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HEAD));
    ...
    public Map<Enchantment, PotentialEnchantmentWrapper> getAllowedEnchants() {
        ...
        allowedEnchants.put(Enchantment.WATER_WORKER, new PotentialEnchantmentWrapper(Enchantment.WATER_WORKER, 1, 1, .75f));
        allowedEnchants.put(Enchantment.OXYGEN, new PotentialEnchantmentWrapper(Enchantment.OXYGEN, 3, 5, .9f));
