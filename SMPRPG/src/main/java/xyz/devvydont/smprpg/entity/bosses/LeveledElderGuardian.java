...
public class LeveledElderGuardian extends BossInstance<ElderGuardian> {
    ...
    public @Nullable Collection<LootDrop> getItemDrops() {
        return List.of(
                ...
                // Gear drops
                new ChancedItemDrop(ItemService.generate(CustomItemType.NEPTUNE_HELMET), 100, this),
                new ChancedItemDrop(ItemService.generate(CustomItemType.NEPTUNE_CHESTPLATE), 125, this),
                new ChancedItemDrop(ItemService.generate(CustomItemType.NEPTUNE_LEGGINGS), 110, this),
                new ChancedItemDrop(ItemService.generate(CustomItemType.NEPTUNE_BOOTS), 100, this),
                new ChancedItemDrop(ItemService.generate(CustomItemType.NEPTUNE_TRIDENT), 125, this),
                ...
                new ChancedItemDrop(ItemService.generate(CustomItemType.NEPTUNES_CONCH), 20, this)
        );
    }
}
