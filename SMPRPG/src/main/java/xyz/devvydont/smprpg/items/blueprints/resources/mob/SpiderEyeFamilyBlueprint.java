...
public class SpiderEyeFamilyBlueprint extends CustomCompressableBlueprint {
    ...
    public static final CustomItemType[] CUSTOM_SPIDER_EYE_MATERIALS = {
            CustomItemType.PREMIUM_SPIDER_EYE,
