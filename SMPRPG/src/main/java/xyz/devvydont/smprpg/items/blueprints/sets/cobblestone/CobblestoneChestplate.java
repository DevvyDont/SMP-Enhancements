...
public class CobblestoneChestplate extends CustomArmorBlueprint implements ToolBreakable, Trimmable, Dyeable, Craftable {
    ...
    public Collection<AttributeEntry> getAttributeModifiers() {
        return List.of(
                new AdditiveAttributeEntry(AttributeWrapper.DEFENSE, 140),
