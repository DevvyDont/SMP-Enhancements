...
public class StringFamilyBlueprint extends CustomCompressableBlueprint {

    public static final List<CompressionRecipeMember> COMPRESSION_FLOW = List.of(
            new CompressionRecipeMember(new MaterialWrapper(Material.STRING)),
            new CompressionRecipeMember(new MaterialWrapper(CustomItemType.PREMIUM_STRING)),
