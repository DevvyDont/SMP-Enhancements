...
public class MystbloomBoots extends MystbloomArmorSet {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                new AdditiveAttributeEntry(AttributeWrapperLegacy.DEFENSE, ItemArmor.getDefenseFromMaterial(Material.DIAMOND_BOOTS)),
                new AdditiveAttributeEntry(AttributeWrapperLegacy.HEALTH, ItemArmor.getHealthFromMaterial(Material.DIAMOND_BOOTS)+5),
