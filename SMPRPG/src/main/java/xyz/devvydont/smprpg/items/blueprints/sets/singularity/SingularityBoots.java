...
public class SingularityBoots extends CustomAttributeItem implements IBreakableEquipment, ITrimmable {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                ...
                new AdditiveAttributeEntry(AttributeWrapperLegacy.DEFENSE, 460),
                new AdditiveAttributeEntry(AttributeWrapperLegacy.HEALTH, 230),
