    ...
    public static int getBaseExperienceForBlock(Block block) {
        ...
        int exp = switch (block.getType()) {
            ...
            case CRIMSON_STEM, WARPED_STEM, NETHER_WART_BLOCK, WARPED_WART_BLOCK, STRIPPED_CRIMSON_STEM,
                 STRIPPED_WARPED_STEM -> 12;

            case ACACIA_LOG, BIRCH_LOG, OAK_LOG, CHERRY_LOG, JUNGLE_LOG, SPRUCE_LOG, DARK_OAK_LOG, MANGROVE_LOG -> 10;
            ...
            case ACACIA_PLANKS, BAMBOO_PLANKS, BIRCH_PLANKS, CHERRY_PLANKS, CRIMSON_PLANKS, DARK_OAK_PLANKS, JUNGLE_PLANKS, MANGROVE_PLANKS, OAK_PLANKS, SPRUCE_PLANKS, WARPED_PLANKS -> 3;
